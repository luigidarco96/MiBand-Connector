...
import com.luigidarco.mibandconnector.listeners.HeartRateNotifyListener;
import com.luigidarco.mibandconnector.listeners.NotifyListener;
import com.luigidarco.mibandconnector.listeners.RealtimeStepsNotifyListener;
import com.luigidarco.mibandconnector.modules.BatteryInfo;
import com.luigidarco.mibandconnector.modules.Profile;
import com.luigidarco.mibandconnector.modules.Protocol;
import com.luigidarco.mibandconnector.modules.StepsInfo;
...
public class MiBand extends Service {
    ...
    public void setHeartRateScanListener(final HeartRateNotifyListener listener) {
        this.io.setNotifyListener(Profile.UUID_HEART_SERVICE, Profile.UUID_HEART_CHAR, (NotifyListener) data -> {
            if (data.length == 2) {
